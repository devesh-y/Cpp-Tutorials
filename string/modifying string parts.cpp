...
int main()
{
    ...
    s1.replace(9, 5, s2);  //first argument is position of first letter and second argument is length of substring to replaced and third is the string to put to replace----replace "Count" with "Lord"
